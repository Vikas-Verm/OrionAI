...
export const careerAPI = {
  ...
  importJob: (payload) => api.post("/api/career/jobs/import", payload),
  confirmImportedJob: (payload) => api.post("/api/career/jobs/import/confirm", payload),
  resumeMatch: (id, payload = {}) => api.post(`/api/career/applications/${id}/resume-match`, payload),
  prepareApplication: (id) => api.post(`/api/career/applications/${id}/prepare`),
