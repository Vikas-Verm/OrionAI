...
/* ── Sidebar ─────────────────────────────────────────────── */
.sl-sidebar { width:258px; flex-shrink:0; min-width:0; background:var(--bg-surface); border-right:1px solid var(--border-subtle); display:flex; flex-direction:column; overflow:hidden; }
...
.sl-ws-dropdown { position:absolute; top:calc(100% + 4px); left:8px; right:8px; background:var(--bg-surface); border:1px solid var(--border-default); border-radius:var(--radius-md); padding:8px; z-index:100; box-shadow:var(--shadow-lg); }
...
.sl-sidebar-action-btn.active { background:rgba(79,140,255,0.1); color:var(--accent-hover); border-color:rgba(79,140,255,0.22); }
...
.sl-search { width:100%; padding:8px 22px 8px 24px; background:rgba(255,255,255,.045); border:1px solid var(--border-default); border-radius:var(--radius-sm); color:var(--text-primary); font-size:11.5px; outline:none; box-sizing:border-box; transition:border-color 0.15s, box-shadow 0.15s; }
.sl-search:focus { border-color:rgba(79,140,255,0.24); box-shadow:0 0 0 4px rgba(79,140,255,0.08); }
...
.sl-ch-item.active { background:rgba(79,140,255,.1); }
...
/* Profile popup */
.sl-profile-popup { position:absolute; bottom:calc(100% + 6px); left:0; right:0; background:var(--bg-surface); border:1px solid var(--border-default); border-radius:var(--radius-md); padding:8px; z-index:100; box-shadow:var(--shadow-lg); }
...
/* ── Main area ───────────────────────────────────────────── */
.sl-main { flex:1; display:flex; flex-direction:column; overflow:hidden; min-width:0; min-height:0; }

/* Topbar */
.sl-topbar { display:flex; align-items:center; gap:8px; padding:10px 16px; background:var(--bg-elevated); border-bottom:1px solid var(--border-subtle); flex-shrink:0; min-height:46px; font-size:12.5px; color:var(--text-muted); }

/* Chat header */
.sl-chat-header { display:flex; align-items:center; gap:9px; padding:10px 15px; background:var(--bg-elevated); border-bottom:1px solid var(--border-subtle); flex-shrink:0; }
...
.sl-hdr-btn { display:flex; align-items:center; gap:6px; padding:6px 11px; background:rgba(255,255,255,.035); border:1px solid var(--border-default); border-radius:var(--radius-sm); color:var(--text-secondary); font-size:12px; cursor:pointer; font-family:inherit; transition:all 0.1s; white-space:nowrap; }
...
.sl-hdr-icon-btn { width:31px; height:31px; background:rgba(255,255,255,.035); border:1px solid var(--border-default); border-radius:var(--radius-sm); color:var(--text-muted); cursor:pointer; display:flex; align-items:center; justify-content:center; text-decoration:none; transition:all 0.1s; }
...
/* Message toolbar */
.sl-msg-toolbar { position:absolute; right:5px; top:2px; display:flex; gap:2px; background:var(--bg-surface); border:1px solid var(--border-default); border-radius:14px; padding:4px; box-shadow:var(--shadow-md); z-index:10; }
...
/* Send bar */
.sl-sendbar { flex-shrink:0; background:var(--bg-surface); border-top:1px solid var(--border-subtle); padding:10px 18px 18px; position:relative; }
...
.sl-send-box { background:rgba(255,255,255,.045); border:1px solid rgba(255, 255, 255, 0.09); border-radius:var(--radius-md); overflow:hidden; transition:border-color 0.15s, box-shadow 0.15s; }
...
.sl-att-chip { display:flex; align-items:center; gap:5px; background:var(--bg-overlay); border:1px solid var(--border-default); border-radius:var(--radius-md); padding:3px 9px; font-size:12px; color:var(--text-secondary); }
...
.sl-send-btn { width:44px; height:44px; background:var(--accent); border:1px solid rgba(79, 140, 255, 0.22); border-radius:var(--radius-md); color:white; cursor:pointer; display:flex; align-items:center; justify-content:center; transition:opacity 0.15s, transform 0.15s, box-shadow 0.15s; }
...
/* Context menu */
.sl-ctx-menu { position:fixed; z-index:1000; background:var(--bg-surface); border:1px solid var(--border-default); border-radius:var(--radius-md); padding:6px; box-shadow:var(--shadow-lg); min-width:175px; }
...
/* Modals */
.sl-modal-bg { position:absolute; inset:0; z-index:200; background:rgba(0,0,0,0.65); display:flex; align-items:center; justify-content:center; }
.sl-modal { background:var(--bg-surface); border:1px solid var(--border-default); border-radius:var(--radius-lg); width:450px; max-width:90vw; box-shadow:var(--shadow-lg); overflow:hidden; }
...
@media (max-width: 1366px) {
  .sl-sidebar { width:236px; }
  .sl-topbar,
  .sl-chat-header,
  .sl-huddle-banner,
  .sl-messages,
  .sl-sendbar { padding-left:14px; padding-right:14px; }
  .sl-msg-body { padding-right:64px; }
}
...
@media (max-width: 1024px) {
  ...
  .sl-huddle-banner,
  .sl-send-foot,
  .sl-modal-footer { flex-wrap:wrap; }
  .sl-chat-hdr-actions,
  .sl-huddle-join-btn { flex-wrap:wrap; }
  .sl-msg-body { padding-right:0; }
  .sl-modal,
  .sl-modal.lg { width:min(100%, 560px); }
}
