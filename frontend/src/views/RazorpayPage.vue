...
<style scoped>
.rz-page { height:100%; overflow-y:auto; padding:28px; color:var(--text-primary); }
...
.rz-back-btn,.rz-secondary-btn { background:rgba(255,255,255,0.06); color:var(--text-primary); border:1px solid var(--border-subtle); }
.rz-primary-btn { background:linear-gradient(135deg,#2563eb,#1d4ed8); color:white; font-weight:600; }
...
.rz-hero { display:grid; grid-template-columns:1.5fr 1fr; gap:16px; padding:24px; border:1px solid var(--border-subtle); border-radius:22px; background:linear-gradient(135deg, rgba(37,99,235,0.18), rgba(10,17,53,0.38)); margin-bottom:18px; }
.rz-chip { display:inline-flex; padding:6px 10px; border-radius:999px; font-size:11px; letter-spacing:.08em; font-weight:700; color:#93c5fd; border:1px solid rgba(147,197,253,0.24); margin-bottom:12px; }
...
.rz-stat-card { padding:18px; border-radius:18px; background:rgba(255,255,255,0.05); border:1px solid rgba(255,255,255,0.08); display:flex; flex-direction:column; gap:6px; }
...
.rz-state { padding:22px; border-radius:18px; border:1px solid var(--border-subtle); background:rgba(255,255,255,0.03); color:var(--text-muted); }
...
.rz-row { display:flex; justify-content:space-between; gap:16px; padding:18px; border-radius:18px; border:1px solid var(--border-subtle); background:rgba(255,255,255,0.03); }
...
.rz-status--default { background:rgba(255,255,255,0.07); color:var(--text-muted); border:1px solid rgba(255,255,255,0.1); }
